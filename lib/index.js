  ...
  compileAmd = function(file, baseFile, baseDir, params, opt) {
    return Q.Promise(function(resolve, reject) {
      ...
      return amdBundler.bundle(file, {
        ...
        var define, err, exp, factory, mod, outPath, processDefQueue, ref, ref1, ref2, src;
        if (params.render) {
          ...
          if ((ref = params.process) === 'yes' || ref === 'true' || ref === '1') {
          ...
          if ((ref1 = params.out) === 'no' || ref1 === 'false' || ref1 === '0') {
            ...
            if (params.out && ((ref2 = params.out) !== 'yes' && ref2 !== 'true' && ref2 !== '1')) {
